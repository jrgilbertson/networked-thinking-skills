...
Each DAE section is a sentence whose first visible letter is capitalized, including a leading wikilink alias. Mid-sentence aliases stay lowercase. A section that opens with inline math may keep the math token first, and a mixed-case first word such as gRPC stays as written.
